...
def main():
    ...
    # to me.
    state = [None, None, None, None, None, None, None, None, None, None, None, None]
    state[0] = [("a", Set([1])), ("b", Set([6]))]
    state[1] = [("a", Set([2])), ("b", Set([3]))]
    state[2] = [("a", Set([4])), ("b", Set([5])), ("E", Set([5]))]
    state[3] = [("a", Set([6])), ("b", Set([3])), ("E", Set([2,5]))]
    state[4] = [("a", Set([8])), ("b", Set([9]))]
    state[5] = [("a", Set([1])), ("b", Set([2])), ("E", Set([2]))]
    state[6] = [("a", Set([4])), ("b", Set([7]))]
    state[7] = [("a", Set([3])), ("b", Set([5]))]
    state[8] = [("a", Set([9,10])), ("b", Set([10]))]
    state[9] = [("a", Set([8,9])), ("b", Set([8,9]))]
    state[10] = [("a", Set([9])), ("b", Set([8,10]))]
    state[11] = [("a", Set([1])), ("b", Set([6]))]
    ...
    print "%-30s %-30s %-30s" % ("State", "a", "b")
    for key in dfa:
        if len(dfa[key]) > 0:
            print "%-30s %-30s %-30s" % (list(key), print_a(dfa[key]), print_b(dfa[key]))
        else:
            print "%-30s %-30s %-30s" % (list(key), "--", "--")
